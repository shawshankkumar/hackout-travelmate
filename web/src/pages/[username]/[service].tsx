...
export default function Service({
  ...
  const [confirmDetails, setConfirmDetails] = React.useState<boolean>(false);
  return (
    <main className="my-3 lg:my-0 lg:h-screen lg:w-screen lg:bg-purple-200 lg:flex lg:justify-center lg:items-center lg:gap-12">
          ...
          <section className="mx-3 lg:mx-0 md:max-w-[80%] md:mx-auto lg:max-w-[46%] lg:p-8 lg:rounded-xl bg-white">
            <section>
              ...
              <div className="flex justify-between items-center my-5">
                ...
                <Button size={"sm"} onClick={() => setConfirmDetails(true)}>
                  Confirm Details
                </Button>
              </div>
            </section>
            ...
            <section>
              <p className="text-sm mt-3 text-black/70">
                Hey there! I am your go-to Indian travel influencer, on a
                thrilling journey to uncover the wonders of my incredible
                homeland. Join me as I traverse the diverse landscapes, immerse
                in rich cultures, and unveil hidden treasures that make India
                truly extraordinary. Through my lens, I share not just
                destinations, but the soul-stirring stories behind them,
                offering travel enthusiasts a front-row seat to the beauty and
                magic that is uniquely India. Ready to explore together?
              </p>
            </section>
      ...
      {confirmDetails && (
        <section className=" bg-white w-[80%] h-[50vh] relative">
          <div className=" bg-purple-200 h-28 w-28 rounded-full absolute left-0 top-[40%]"></div>
        </section>
      )}
    </main>
  );
